        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 lg:space-y-8 order-2 lg:order-1">
            ...
            <p className="text-white text-base sm:text-lg lg:text-xl leading-relaxed">
              Aprendé a desarrollar aplicaciones y automatizaciones con herramientas de IA y No Code. Crea tu propio producto y lanzalo al mercado, o construye soluciones para clientes y empresas.
            </p>
