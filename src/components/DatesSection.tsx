      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto mt-8">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://tally.so/r/w49bBo" className="bg-labora-neon text-black px-8 py-4 rounded-lg font-bold text-lg hover:bg-labora-neon/80 transition-all duration-200 transform hover:scale-105 shadow-lg inline-block text-center">
              APLICAR AHORA
            </a>
