      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Mira lo que <span className="gradient-text">podrás crear</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto bg-gray-900 rounded-2xl overflow-hidden shadow-xl animate-fade-in-up">
          ...
          <div className="bg-white p-6">
            <h3 className="text-xl font-semibold mb-2">Plataforma de gestión de proyectos</h3>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-labora-purple/10 text-labora-purple rounded-full text-sm">Lovable</span>
        ...
        <div className="text-center mt-12">
          <a href="#contacto">
            <Button className="bg-labora-purple hover:bg-labora-purple/90 px-8 py-6 text-base">
