    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center py-12 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-auto flex flex-col items-center relative z-10 animate-fade-in-up">
        ...
        <div className="w-full flex flex-col gap-4 mb-10">
          ...
          <a 
            href="https://wa.me/5491138142899?text=Hola,%20quiero%20informaci%C3%B3n%20sobre%20las%20asesor%C3%ADas%201:1%20y%20vengo%20de%20TikTok"
            target="_blank"
          ...
          <a 
            href="https://wa.me/5491138142899?text=Hola,%20vengo%20de%20TikTok,%20quiero%20m%C3%A1s%20informaci%C3%B3n"
            target="_blank"
            rel="noopener noreferrer"
